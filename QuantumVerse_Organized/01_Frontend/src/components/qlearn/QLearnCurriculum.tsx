...
export function QLearnCurriculum() {
    ...
    <AppShell>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        {LEVEL_META.map((meta, index) => {
          ...
          const description = levelModules[0]?.description || meta.description;
          ...
          const complete = levelCompleted === lessonCount && lessonCount > 0;
          ...
          return (
            ...
            >
              <Link href={`/qlearn/level/${meta.level}`} className="group block">
                  ...
                  <div className="relative p-5 sm:p-6">
                      ...
                      <div className="flex min-w-0 items-center gap-4">
                        ...
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            <p className="qv-label">Level {meta.level}</p>
                    ...
                    <div className="mt-5 grid grid-cols-3 gap-2">
                      <div className="rounded-xl border border-white/[0.06] bg-white/[0.025] p-3 text-center transition-colors group-hover:border-white/[0.09]">
                        ...
                        <p className="qv-label">Lessons</p>
                      ...
                      <div className="rounded-xl border border-white/[0.06] bg-white/[0.025] p-3 text-center transition-colors group-hover:border-white/[0.09]">
                        ...
                        <p className="qv-label">Activities</p>
      ...
      <div className="mt-6 rounded-2xl border border-violet-400/10 bg-violet-400/[0.025] p-5 backdrop-blur-xl">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-white">Learn by doing</p>
